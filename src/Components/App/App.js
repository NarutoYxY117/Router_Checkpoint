...
import Desscription from '../Description/Desscription.js';
...
const info = [
  ...
  { title:'Planet Earth', trailer:'https://www.youtube.com/embed/c8aFcHFu8QM', img:'/image/Planet Earth.jpg', description:"Emmy Award-winning, 11 episodes, five years in the making, the most expensive nature documentary series ever commissioned by the BBC, and the first to be filmed in high definition.", posterURL:"www.planetearth.com", rating:9.4 },
  ...
  { title:'The Expanse', trailer:'https://www.youtube.com/embed/M0QwBp_da28', img:'/image/The Expanse.jpg', description:"In the 24th century, a disparate band of antiheroes unravel a vast conspiracy that threatens the Solar System's fragile state of cold war.", posterURL:"www.theexpanse.com", rating:8.5 },
  { title:'The Walking Dead', trailer:'https://www.youtube.com/embed/sfAc2U20uyg', img:'/image/The Walking Dead.jpg', description:"Police officer (Rick) wakes up from a coma in which he was in for several months as a result of being shot while on the job, to find that the world has been ravaged by the zombies and he is the only survivor. An army of the zombies, events escalate.", posterURL:"www.thewalkingdead.com", rating:8.2 },
...
function App(){
  ...
  return(
    <div className="App">
        ...
        <Routes>
          <Route path='/' element={<MovieList list={filtredList} adding={adding}/>}/>
          <Route path='/:title' element={<Desscription list={list}/>}/>
        </Routes>
